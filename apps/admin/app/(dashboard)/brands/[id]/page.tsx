    ...
    if (loading) {
        return (
            <div className="h-[60vh] flex flex-col items-center justify-center gap-6">
                ...
                <p className="text-gray-400 font-black uppercase tracking-[0.2em] text-xs">Synchronizing Partnership...</p>
            </div>
        );
    }
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 border-b border-gray-100 pb-10">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            <h1 className="text-4xl font-black text-gray-900 tracking-tighter">Modify Partner</h1>
                            <Shield className="h-6 w-6 text-indigo-600" />
                        </div>
                        <p className="text-gray-400 font-bold uppercase tracking-[0.2em] text-[10px]">Editing Artifact: <span className="text-gray-900">{watchName}</span></p>
                    </div>
                </div>
                <div className="flex gap-4">
                    ...
                    >
                        ...
                        {saving ? 'Synchronizing...' : 'Authorize Revision'}
                    </Button>
                </div>
            </div>
                                ...
                                {logoPreview ? (
                                    <div className="relative w-full h-full">
                                        ...
                                        <button
                                            ...
                                            className="absolute top-2 right-2 p-2 bg-rose-500 rounded-full text-white opacity-0 group-hover:opacity-100 transition-all"
                                        >
