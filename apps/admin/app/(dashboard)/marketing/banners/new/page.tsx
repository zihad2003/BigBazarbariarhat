        ...
        <div className="max-w-[1000px] mx-auto pb-20">
            ...
            <div className="flex items-center justify-between mb-10 pb-6 border-b border-border">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-semibold text-foreground">New Banner</h1>
                        <p className="text-[13px] text-muted-foreground mt-0.5">Create a new promotional banner for your store.</p>
                    </div>
                </div>
