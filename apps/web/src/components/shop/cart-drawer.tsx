                                                ...
                                                <div className="flex gap-6">
                                                    ...
                                                    <div className="flex-1 min-w-0 flex flex-col justify-between py-2">
                                                        <div className="space-y-1">
                                                            ...
                                                            {item.variant && (
                                                                <span className="text-[10px] font-black uppercase text-gray-400 border border-gray-100 px-2 py-0.5 rounded-lg">Config: {item.variant.name}</span>
                                                            )}
                                                        </div>
                                                ...
                                                {savedItems.map((item) => (
                                                    <div key={item.id} className="flex gap-5 p-4 bg-gray-50/50 hover:bg-white rounded-[2rem] border border-transparent hover:border-gray-100 transition-all">
                                                        ...
                                                        <div className="flex-1 flex flex-col justify-center">
                                                            <h3 className="font-black text-sm text-gray-900 line-clamp-1 mb-1">{item.product?.name}</h3>
