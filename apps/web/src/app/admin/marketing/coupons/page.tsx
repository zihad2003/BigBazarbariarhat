...
export default function CouponsPage() {
    ...
    const fetchCoupons = useCallback(async () => {
        setLoading(true);
        try {
            const response = await MarketingService.getCoupons(searchQuery);
    ...
    const handleCreateCoupon = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await MarketingService.createCoupon(input);
            if (response.success) {
    ...
    const deleteCoupon = async (id: string) => {
        ...
        try {
            const response = await MarketingService.deleteCoupon(id);
