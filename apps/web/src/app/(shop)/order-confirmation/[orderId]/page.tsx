    ...
    if (!order) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6 text-center">
                ...
                <p className="text-gray-400 mb-8 max-w-sm text-sm">We couldn't locate this order in our records.</p>
                <Link href="/products">
        ...
        <div className="bg-white min-h-screen font-sans">
            ...
            <main className="max-w-4xl mx-auto px-6 py-16 lg:py-24 text-center">
                ...
                <div className="flex flex-col items-center mb-16">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-900 uppercase tracking-tight mb-4">Thank you for your order</h1>
                    ...
                    <div className="mt-6 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                        Order Number: <span className="text-black ml-1">#{order.id}</span>
                    </div>
                </div>
                    ...
                    <div className="space-y-10">
                        ...
                        <div>
                            ...
                            <div className="text-sm font-medium text-gray-900 uppercase">
                                {estimatedDate.toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-10">
                        ...
                        <div>
                            ...
                            <div className="text-2xl font-bold text-gray-900">
                                Tk{order.totals.total.toLocaleString()}.00
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-16 space-y-6">
                    ...
                    <div>
                        <Link href="/account/orders" className="text-[10px] font-bold text-gray-400 hover:text-black uppercase tracking-widest transition-colors border-b border-gray-100 hover:border-black pb-1">
                            Manage your orders
                        </Link>
                    </div>
                </div>
