...
export default function NewArrivalsPage() {
    ...
    const FilterContent = () => (
        <div className="space-y-8 lg:space-y-10">
            <div>
                <h3 className="text-xs font-black text-gray-900 uppercase tracking-[0.2em] mb-4 lg:mb-6">{ct.categories}</h3>
                <div className="grid grid-cols-2 gap-2 lg:flex lg:flex-col lg:gap-2">
                    {categories.map(catItem => {
                        const isAllSelected = catItem.key === 'All Categories' && selectedCategory === null;
                        const isMatchSelected = selectedCategory !== null && (selectedCategory === catItem.key || selectedCategory?.toLowerCase() === catItem.key.toLowerCase());
                        const isActive = isAllSelected || isMatchSelected;
                        return (
                            <button
                                key={catItem.key}
                                onClick={() => { setSelectedCategory(catItem.key === 'All Categories' ? null : catItem.key); setCurrentPage(1); setIsFilterOpen(false); }}
                                className={cn(
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-20">
                ...
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <main className="flex-1">
                        ...
                        {/* Toolbar Module */}
                        <div className="flex flex-row items-center justify-between gap-4 mb-12 bg-neutral-50/50 p-3 rounded-xl border border-neutral-100">
